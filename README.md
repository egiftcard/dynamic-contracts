...
```bash
forge install https://github.com/egiftcardv/dynamic-contracts
```
...
```bash
git clone https://github.com/egiftcardv/dynamic-contracts.git
```
...
- [**RouterImmutable**](https://github.com/egiftcardv/dynamic-contracts/blob/main/src/example/RouterImmutable.sol)
...
- [**RouterUpgradeable**](https://github.com/egiftcardv/dynamic-contracts/blob/main/src/example/RouterUpgradeable.sol)
...
- [**RouterRegistryContrained**](https://github.com/egiftcardv/dynamic-contracts/blob/main/src/example/RouterRegistryConstrained.sol)
...
Additionally, since [egiftcard](https://egiftcard.cc/) will be maintaining this repository, you can reach out to us at support@egiftcard.cc or join our [discord](https://discord.gg/egiftcard).

# Authors

- [egiftcard](https://github.com/egiftcardv)
